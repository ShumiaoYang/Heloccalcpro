...
export default function PageShellHeaderAuthEnhanced({
  locale,
  loginLabel,
  logoutLabel,
}: HeaderAuthEnhancedProps) {
  return (
    <AuthSessionProvider>
      <HeaderAuthEnhancedInner locale={locale} loginLabel={loginLabel} logoutLabel={logoutLabel} />
    </AuthSessionProvider>
  );
}

function HeaderAuthEnhancedInner({
  locale,
  loginLabel,
  logoutLabel,
}: HeaderAuthEnhancedProps) {
